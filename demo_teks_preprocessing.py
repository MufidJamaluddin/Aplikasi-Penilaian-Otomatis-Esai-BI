...
teks = 'Dengan memberikan nilai yang tepat untuk setiap term, maka penilaian esai otomatis dapat bekerja lebih baik dalam menentukan apakah suatu term termasuk kata kunci yang mencirikan suatu kategori nilai atau tidak.'
