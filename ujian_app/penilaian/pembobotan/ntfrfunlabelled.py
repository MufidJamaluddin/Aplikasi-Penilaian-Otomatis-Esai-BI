...
class NtfRfUnlabeledWeighter(object):
    ...
    def calculate_rf(self, tf:int, term:str):
        """
        Max RF
        """
        rf = self.ntfrf_repository.get_max_rf(self.idsoal, term)
    ...
    def calculate_and_save(self):
        ...
        for fitur in list_fitur:
            ntf_rf = self.calculate(fitur.tf, fitur.term)
